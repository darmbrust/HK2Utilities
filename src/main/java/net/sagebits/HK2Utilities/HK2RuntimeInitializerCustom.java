...
public class HK2RuntimeInitializerCustom
{
	...
	public static ServiceLocator init(String serviceLocatorName, boolean readInhabitantFiles, String... packageNames) throws IOException, ClassNotFoundException
	{
		...
		AnnotationDetector cf = new AnnotationDetector(new AnnotationReporter(ac, new Class[] { Service.class, Contract.class, Named.class, Singleton.class,
				PerLookup.class, PerThread.class, Proxiable.class, Unproxiable.class }));
